...
ifeq ($(GCC_VER_49),1)
EXTRA_CFLAGS += -Wno-date-time -Wno-error=incompatible-pointer-types	# Fix compile error && warning on gcc 4.9 and later
endif
...
CONFIG_MP_VHT_HW_TX_MODE = y # No floating point support
###################### Platform Related #######################
